...
const Footer = () => {
  ...
  const socialIcons = [
    { 
      name: "Email",
      href: "mailto:admin@thecanvassing.com",
    ...
    { 
      name: "Facebook",
      href: "https://www.facebook.com/people/Canvassing-Reseacher-Zero/61583285961069/",
      icon: (
        <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current">
    ...
    { 
      name: "LinkedIn",
      href: "https://www.linkedin.com/company/thecanvassing",
      icon: (
        <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current">
    ...
    { 
      name: "Instagram",
      href: "https://www.instagram.com/thecanvassing/",
      icon: (
        <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current">
    ...
    { 
      name: "TikTok",
      href: "https://tiktok.com/@thecanvassing",
      icon: (
        <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current">
