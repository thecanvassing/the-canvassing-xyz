        ...
        <div className="container max-w-4xl mx-auto px-6">
          ...
          <div className="prose prose-lg max-w-none space-y-8 text-foreground">
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                We take reasonable measures to help protect information about you from loss, theft, misuse, unauthorized access, disclosure, alteration, and destruction. However, no internet or electronic storage system is completely secure.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                You have the right to access, update, or delete your personal information. You may also have the right to object to or restrict certain processing of your data, and to request portability of your data.
              </p>
            </section>
